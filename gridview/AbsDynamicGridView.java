...
public class AbsDynamicGridView extends GridView {
    ...
    private Deque<DynamicGridModification> mModificationStack;
    ...
    public AbsDynamicGridView(Context context) {
        super(context);
        init(context);
    }

    public AbsDynamicGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AbsDynamicGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void undoLastModification() {
        if (mUndoSupportEnabled && mModificationStack != null && !mModificationStack.isEmpty()) {
    ...
    private AbsAdapterInterface getAdapterInterface() {
        return ((AbsAdapterInterface) getAdapter());
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mUndoSupportEnabled && mCurrentModification != null && !mCurrentModification.getTransitions().isEmpty()) {
    ...
    private void handleCellSwitch() {
        ...
        for (Long id : idList) {
            ...
            if (view != null) {
                ...
                if ((aboveRight(targetColumnRowPair, mobileColumnRowPair)
                    ...
                    float xDiff = Math.abs(AbsGridUtils.getViewX(view) - AbsGridUtils.getViewX(mMobileView));
                    float yDiff = Math.abs(AbsGridUtils.getViewY(view) - AbsGridUtils.getViewY(mMobileView));
        ...
        if (targetView != null) {
            ...
            final AbsAdapterInterface adapter = getAdapterInterface();
    ...
    private OnScrollListener mScrollListener = new OnScrollListener() {
        ...
        public void checkAndHandleFirstVisibleCellChange() {
            ...
            if (mCellIsMobile && mMobileItemId != INVALID_ID && mCurrentFirstVisibleItem != mPreviousFirstVisibleItem) {
                updateNeighborViewsForId(mMobileItemId);
                handleCellSwitch();
        ...
        public void checkAndHandleLastVisibleCellChange() {
            ...
            if (mCellIsMobile && mMobileItemId != INVALID_ID && currentLastVisibleItem != previousLastVisibleItem) {
                updateNeighborViewsForId(mMobileItemId);
                handleCellSwitch();
            }
