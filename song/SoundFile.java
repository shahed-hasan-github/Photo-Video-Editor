...
/**
 * SoundFile is the parent class of several subclasses that each
...
public class SoundFile {
    public interface ProgressListener {
        /**
         * Will be called by the SoundFile subclass periodically
    ...
    static final int BEST_NUMBER = 0;
     ...
     * otherwise returns -1.
     */
    public int getSeekableFrameOffset() {
        return -1;
    }
