...
public class AdaptiveMulti extends SoundFile {
    public static Factory getFactory() {
        return new Factory() {
            public SoundFile create() {
                return new AdaptiveMulti();
            }
    ...
    public void readFile(File inputFile)
        ...
        try (FileInputStream stream = new FileInputStream(mInputFile)) {
    ...
    int parseAMRFrame(InputStream stream, int maxLen, int[] prevEner)
        ...
        int blockSize = blockSizes[frameType];
                ...
                for (int i = 0; i < 4; i++) {
                    int gcode0 =
                            (385963008 +
                                    ...
                                    prevEner[2] * 2785 +
                                    prevEner[3] * 1556) >> 15;
                    int quaEner = quaEnerMr515[gain[i]];
                    int gFac = gainFacMr515[gain[i]];
            ...
            case 7:
                ...
                for (int subframe = 0; subframe < 4; subframe++) {
                    ...
                    if (subframe == 0 || subframe == 2) {
                        ...
                        t0 = tomin + (index + 5) / 6 - 1;
                    }

                    int pitSharp =
                            (quaGainPitch[adaptiveGain[subframe]] >> 2) << 2;
                    if (pitSharp > 16383) {
                        pitSharp = 32767;
                    } else {
                        pitSharp *= 2;
                    ...
                    int gainCode =
                            ((gCode0 * quaGainCode[3 * index]) >> 15) << 1;
                    ...
                    int quaEnerMR122 = quaGainCode[3 * index + 1];
                    prevEner[3] = prevEner[2];
                    prevEner[2] = prevEner[1];
                    prevEner[1] = prevEner[0];
    ...
    private static int[] blockSizes = {
            12, 13, 15, 17, 19, 20, 26, 31,
            5, 0, 0, 0, 0, 0, 0, 0 };

    private static int[] gainFacMr515 = {
    ...
    private static int[] quaEnerMr515 = {
    ...
    private static int[] quaGainCode = {
    ...
    private static int[] gainFacMr475 = {
    ...
    private static int[] quaGainPitch = {
